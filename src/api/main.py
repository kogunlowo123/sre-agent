...
app = FastAPI(
    title="SRE Agent",
    description="Site Reliability Engineering agent that defines and monitors SLOs/SLIs, manages error budgets, performs capacity planning, automates toil reduction, conducts chaos engineering experiments, and provides reliability scoring across services.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
