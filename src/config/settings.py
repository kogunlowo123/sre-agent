"""Application configuration for SRE Agent."""
...
class Settings(BaseSettings):
    ...
    opensearch_index: str = Field(default="sre_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="sre-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="sre-agent", description="A2A agent ID")
